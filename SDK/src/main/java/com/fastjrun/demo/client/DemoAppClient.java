    ...
    extends BaseAppClient
{
    ...
    public void register(RegistserRestRequestBody requestBody, String appKey, String appVersion, String appSource, String deviceId) {
    ...
    public com.fastjrun.demo.packet.app.LoginRestResponseBody login(com.fastjrun.demo.packet.app.LoginRestRequestBody requestBody, String appKey, String appVersion, String appSource, String deviceId) {
        StringBuilder sbUrlReq = new StringBuilder(this.appUrlPre);
        sbUrlReq.append("/app/user/");
    ...
    public com.fastjrun.demo.packet.app.LoginRestResponseBody loginv1_1(com.fastjrun.demo.packet.app.LoginRestRequestBody requestBody, String appKey, String appVersion, String appSource, String deviceId) {
        StringBuilder sbUrlReq = new StringBuilder(this.appUrlPre);
        sbUrlReq.append("/app/user/");
    ...
    public com.fastjrun.demo.packet.app.LoginRestResponseBody autoLogin(AutoLoginRestRequestBody requestBody, String appKey, String appVersion, String appSource, String deviceId) {
        StringBuilder sbUrlReq = new StringBuilder(this.appUrlPre);
        sbUrlReq.append("/app/user/");
